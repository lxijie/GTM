...
if __name__ == '__main__':
    ...
    parser.add_argument('--backbone', type=str, default='Linear', help='models backbone')
    ...
    args.data = 'ETTm1'  # 'custom_new'#
    args.data_path = 'ETTm1.csv'
    # args.root_path = '/data/dataset/train'
    args.root_path = '/data/time_data/dataset/ETT-small/'

    # basic config
    args.task_name = 'long_term_forecast'#[long_term_forecast,pre_train,anomaly_detection]
    args.logs_dir = './logs_new/long_term_forecast/'
    args.model_id = 'ETTm1'
